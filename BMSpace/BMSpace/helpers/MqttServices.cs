...
namespace BMSpace.helpers
{
    public class MqttService
    {
        ...
        void SetupMqtt()
        {
            string IPBrokerAddress = CONSTANTS.IPBrokerAddress;
            string ClientUser = CONSTANTS.ClientUser;
            string ClientPass = CONSTANTS.ClientPass;
            ...
            var clientId = "bmc-home-watch";//Guid.NewGuid().ToString();
